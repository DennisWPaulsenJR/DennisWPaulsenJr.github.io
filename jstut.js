...
button {
    border: 2 px solid black;background: #E5E4E2;
    font - size: .5 em;
    font - weight: bold;
    color: black;
    padding: .8 em 2 em;
...
onClick = "alert('Hello');" > Say Hello < /a><br / >

    <!-- Call a function on click -->
    <
    a href = "JavaScript:void(0)"
onClick = "openAlert('Hi how are you');" > Say Something < /a><br / >
...
size = "30" > < br / >
    ...
    Mouse X: < input type = "text"
id = "mouseX" > < br / >
    Mouse Y: < input type = "text"
id = "mouseY" > < br / >
